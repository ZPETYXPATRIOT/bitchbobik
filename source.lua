--[[
    ...
    [nc4hew] - best guy who fix is shit
    :3
SHITTYTTYTYTTYY
...
LPH_NO_VIRTUALIZE(function() -- Make UI
    ...
    local title
    if isfile(folderName .. "/chettname.json") then
        local userThemeData = httpService:JSONDecode(readfile(folderName .. "/chettname.json"))
        title = (userThemeData.Title == "$$$Bitch$$$" and "BitchBobik.reel") or userThemeData.Title
        wapus.theme = {
    ...
    antiaim:AddDropdown("Yaw Mode", "Relative", {"Relative", "Absolute", "robot"}, getCallback("Anti Aim%%Yaw Mode"))
    ...
    antiaim:AddSlider("Spin Speed", 180, 0, 18000, 1, " Degrees/Second", getCallback("Anti Aim%%Spin Speed"))
